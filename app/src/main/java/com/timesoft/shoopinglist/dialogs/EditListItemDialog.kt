...
import com.timesoft.shoopinglist.databinding.EditListItemDialogBinding
import com.timesoft.shoopinglist.entities.ShopListItem

object EditListItemDialog {

    fun showDialog(context: Context, item: ShopListItem, shopListItemListenerDialog: ShopListItemListenerDialog) {
        ...
        binding.apply {
            ...
            bUpdate.setOnClickListener {
                if (edName.text.toString().isNotEmpty()){
                    ...
                    shopListItemListenerDialog.onClick(item.copy(name = edName.text.toString(), itemInfo = edInfo.text.toString()))
                }
                dialog?.dismiss()
            }
    ...
    interface ShopListItemListenerDialog {
